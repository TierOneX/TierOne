                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-10 gap-4">
                    <div>
                        ...
                        <h2 className="text-2xl lg:text-4xl font-black italic uppercase text-white">
                            TORNEOS{" "}
                            <span className="text-[#e31837]">PRÓXIMOS</span>
                        </h2>
                    </div>
                    <Link
                        href="/tournaments"
    ...
    return (
        ...
        >
            <div className="flex flex-col lg:flex-row items-stretch">
                ...
                <div
                    className="relative lg:w-[200px] h-[120px] lg:h-auto flex-shrink-0 overflow-hidden"
                ...
                <div className="flex-1 p-5 lg:p-6">
                    <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-8">
                        ...
                        {/* Premio */}
                        <div className="lg:w-[120px] lg:text-center">
                            <p className="text-[10px] font-bold uppercase tracking-widest text-gray-600 mb-2">
                                Premio
                            </p>
                            <p className="text-[#e31837] font-black text-2xl leading-none">
                                {torneo.premio_total}€
                            </p>
                        </div>

                        {/* Formato */}
                        <div className="lg:w-[140px] lg:text-center">
                            <p className="text-[10px] font-bold uppercase tracking-widest text-gray-600 mb-2">
                                Formato
                            </p>
                        ...
                        <div className="lg:w-[180px]">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-xs text-gray-500 font-medium tabular-nums">
                                    {inscritos}/{torneo.max_participantes}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="lg:ml-auto flex-shrink-0">
                            <span
                                className={`inline-flex items-center gap-2 px-6 py-3 rounded-lg text-xs font-black uppercase tracking-wider transition-all ${
