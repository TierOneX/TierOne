...
const banners = [
    {
        ...
        subtitle:
            "Únete al torneo de League of Legends más prestigioso de la temporada.",
    ...
    },
    {
        ...
        subtitle:
            "Descubre nuestra colección exclusiva de merchandising gaming.",
        cta: "VER TIENDA",
        ctaLink: "/shop",
    ...
    },
    {
        ...
        subtitle:
            "Matchmaking inteligente, rankings dinámicos y partidas competitivas.",
        cta: "JUGAR AHORA",
        ctaLink: "/matches",
        ...
        >
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-8 flex items-center h-full">
                <div className="w-full max-w-2xl">
                    {/* Badge */}
                    <div
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-[0.2em] mb-6 text-[#e31837]"
                        style={{
