...
const estadoBadge = (estado) => {
    const map = {
        ...
        en_revision:
            "bg-yellow-50 text-yellow-700 border border-yellow-100 font-bold",
        resuelta:
    ...
    const renderRow = (reporte) => (
        ...
        >
            ...
            <td className="px-6 py-4">
                <span
                    className={`inline-flex px-2 py-0.5 rounded text-xs font-bold uppercase ${tipoBadge(reporte.tipo)}`}
                >
                    {reporte.tipo}
                </span>
            </td>
            ...
            <td className="px-6 py-4">
                <span
                    className={`inline-flex px-2.5 py-0.5 rounded-full text-[10px] uppercase border shadow-sm ${estadoBadge(reporte.estado)}`}
                >
                    {reporte.estado}
                </span>
            </td>
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-bold text-black">
                                                {selectedReport.usuario_reporta}
                                            </p>
                                        </div>
                                    </div>
                                    <div>
                                ...
                                {modalMode === "edit" ? (
                                    ...
                                    <div className="space-y-4 px-1 mt-6">
                                        <h4 className="font-black border-b border-gray-100 pb-3 flex items-center gap-2 uppercase text-xs tracking-widest text-black">
                                            <span className="bg-green-50 text-green-600 p-1.5 rounded-lg flex items-center justify-center">
                                                <CheckCircle size={14} />
                                            </span>
                                            Resolución Actual
                                        </h4>
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <p className="font-bold uppercase text-amber-600 text-sm mt-1">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-bold text-black text-sm mt-1">
                                                    {admins.find(
                                                        (a) =>
                                                            a.id ==
                                                            selectedReport.id_resuelto_por,
                                                    )?.name || "Sin Asignar"}
                                                </p>
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div className="text-sm text-gray-500 bg-gray-50 p-4 rounded-xl border border-gray-100 mt-2 min-h-[80px]">
                                                {selectedReport.resolucion ||
                                                    "No hay resolución registrada aún."}
                                            </div>
                                        </div>
                                    </div>
                                )}
