...
{
    private const DEFAULT_TOURNAMENT_IMAGE = '/images/landing/torneos.jpg';
    ...
    public function resolveTournamentImageUrl(string $gameName, ?string $storedImageUrl = null, ?string $gameSlug = null): string
    {
        ...
        return $this->resolveTournamentLocalImageUrl($storedImageUrl, $gameSlug);
    }

    public function resolveTournamentLocalImageUrl(?string $storedImageUrl = null, ?string $gameSlug = null): string
    {
        ...
        return self::DEFAULT_TOURNAMENT_IMAGE;
    }
    ...
    private function getTwitchGameImage(string $gameName): ?string
    {
        ...
        try {
            ...
            // Fallback para nombres que no matchean exacto con /games?name=
            if (! $imageUrl) {
